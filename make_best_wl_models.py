...
regularizer = "l1"
def make_wl_model(input_tuple):
    
    # Make the model
    input_layer = Input(shape=input_tuple)
    hidden_layer_1 = Dense(10, activation="relu", kernel_regularizer=regularizer)(input_layer)
    hidden_layer_2 = Dense(5, activation="relu", kernel_regularizer=regularizer)(hidden_layer_1)
